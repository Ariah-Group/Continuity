...
<h1>Details for This Application</h1>

<s:form action="saveInformationTechnologyDepartmentApplication">
    ...
    <div id="listcontainer">
        ...
        <label for="dto.functionalOwner">Functional Owner:</label>
        <s:textfield name="dto.functionalOwner" readonly="%{#session.planAccessControl.isInputReadOnly}" cssClass="%{#session.planAccessControl.addClass}" maxlength="256"/>
     
        <label for="dto.technicalOwner">Technical Owner:</label>    
        <s:textfield name="dto.technicalOwner" readonly="%{#session.planAccessControl.isInputReadOnly}" cssClass="%{#session.planAccessControl.addClass}" maxlength="256"/>

        <label for="dto.type.id">Application Type:</label>
        <s:select
            name="dto.type.id"
        ...
        <label for="dto.backupMedia.id">Backup Media:</label>
        <s:select
        ...
        <label for="dto.backupType.id">Is backup auto or manual?</label>
        <s:select
        ...
        <label for="dto.isDatabaseApplication.id">Is this a database application?</label>
        <s:select
            name="dto.isDatabaseApplication.id"
            disabled="%{#session.planAccessControl.isSelectDisabled}"
            list="responses"
            listValue="value"
            headerKey=""
        ...
        <label for="dto.isDataToAndFromCoreSystem.id">Does this application move data to-or-from any core campus systems?</label>
        <s:select
            name="dto.isDataToAndFromCoreSystem.id"
            disabled="%{#session.planAccessControl.isSelectDisabled}"
            list="responses"
            listValue="value"
            headerKey=""
        ...
        <label for="dto.campusSystems">If so, what campus systems? Explain:</label>
        <s:textarea readonly="%{#session.planAccessControl.isInputReadOnly}" cssClass="%{#session.planAccessControl.addClass}" name="dto.campusSystems" rows="3"/>  
      
        <label for="dto.departmentsImpacted">Departments impacted by failure of this application:</label>
    ...
    <div id="col2">                
        ...
        <label for="dto.technicalExperts">Technical expert(s) for this application:</label>
        ...
        <label for="dto.offsiteStorageFrequency.id">Frequency of offsite storage:</label>
        ...
        <label for="dto.recoveryResult.id">Has a successful recovery been done?</label>
        <s:select

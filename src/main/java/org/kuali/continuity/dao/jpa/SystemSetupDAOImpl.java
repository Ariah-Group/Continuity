...
public class SystemSetupDAOImpl extends BaseDAOImpl implements SystemSetupDAO {

	public SystemSetup getSystemSetup() {
		Query query = super.buildQuery("SystemSetup.all");
		return (SystemSetup) query.getSingleResult();
	}
	
	public SystemSetupSamplePlanDocument getDefaultSamplePlanDocument() {
		Query query = super.buildQuery("SystemSetupSamplePlanDocument.all");
		return (SystemSetupSamplePlanDocument) query.getSingleResult();
	}

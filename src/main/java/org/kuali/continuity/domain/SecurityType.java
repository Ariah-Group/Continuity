...
@Where(clause="LookupName='SysAdminRoleSet'")
@NamedQuery(name="SecurityType.list",
		query="SELECT dObj FROM SecurityType dObj ORDER BY dObj.id")
...
public class SecurityType extends BaseRefDomainObject {

...
@NamedQuery(name="PlanAccessType.list",
		query="SELECT dObj FROM PlanAccessType dObj ORDER BY dObj.id")
...
public class PlanAccessType extends BaseRefDomainObject {

	public PlanAccessType() {
		super();
	}

	public PlanAccessType(String id) {
		super(id);
	}

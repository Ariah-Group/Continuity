...
@Entity
@Table(name="SystemCriticalLevelAppl")
@TypeDef(
	name="stringValueEnum", 
	typeClass=StringValuedEnumType.class)
@SuppressWarnings("serial")
public class SystemCentralApplicationCriticalityLevel extends
		SystemCriticalityLevel implements CentralApplicationCriticalityLevel {

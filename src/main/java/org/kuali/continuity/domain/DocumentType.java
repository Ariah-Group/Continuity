...
@Where(clause="LookupName='DocumentMedium'")
@NamedQuery(name="DocumentType.list",
		query="SELECT dObj FROM DocumentType dObj ORDER BY dObj.id")
...
public class DocumentType extends BaseRefDomainObject {

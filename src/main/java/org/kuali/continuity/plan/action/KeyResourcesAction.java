...
public class KeyResourcesAction extends BasePlanFormAction
	implements PlanNavigationSession {
	
	private KeyResourcesNavigation krNav;

	public KeyResourcesNavigation getKrNav() {
		return this.krNav;
	}

	public void setKrNav(KeyResourcesNavigation krNav) {
		this.krNav = krNav;
		this.setSubNav(krNav);
	}

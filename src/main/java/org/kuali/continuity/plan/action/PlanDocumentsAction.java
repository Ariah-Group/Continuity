...
public class PlanDocumentsAction extends DocumentsAction {

	private DocumentSearchService documentSearchService;
	
	public PlanDocumentsAction(DocumentServiceFactory documentServiceFactory,
	...
	public List<Document> getServiceDocuments() {
		return (List<Document>) this.documentSearchService.getDocumentListByPlanId(this.getSessionPlan().id);
	}

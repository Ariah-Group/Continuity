...
public interface TeamMemberService extends BaseService {

	void create(TeamMember dObj);
	void update(TeamMember dObj);
	void delete(int id);
	TeamMember getById(int id);
	List<TeamMember> getListByOwnerId(int ownerId);

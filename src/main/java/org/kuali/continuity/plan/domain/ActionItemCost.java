...
@NamedQuery(name="ActionItemCost.list",
		query="SELECT dObj FROM ActionItemCost dObj ORDER BY dObj.orderNo")
...
public class ActionItemCost extends BaseRefDomainObject {

	private int orderNo;

	public ActionItemCost() {
		super();
	}

	public ActionItemCost(String id) {
		super(id);
	}

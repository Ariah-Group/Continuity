...
@NamedQuery(name="ActionItemStatus.list",
		query="SELECT dObj FROM ActionItemStatus dObj ORDER BY dObj.orderNo")
...
public class ActionItemStatus extends BaseRefDomainObject {
	...
	public ActionItemStatus(String id) {
		super(id);
	}

...
@NamedQuery(name="ActionItemScope.list",
		query="SELECT dObj FROM ActionItemScope dObj ORDER BY dObj.orderNo")
...
public class ActionItemScope extends BaseRefDomainObject {

	private int orderNo;

	public ActionItemScope() {
		super();
	}

	public ActionItemScope(String id) {
		super(id);
	}

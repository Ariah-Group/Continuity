...
@NamedQuery(name="BackupFrequency.list",
		query="SELECT dObj FROM BackupFrequency dObj ORDER BY dObj.orderNo")
...
public class BackupFrequency extends BaseRefDomainObject {
	...
	public BackupFrequency(String id) {
		super(id);
	}

...
public class CriticalCentralApplicationDAOImpl extends BaseDomainObjectDAOImpl implements
		CriticalCentralApplicationDAO {

	public void create(CriticalCentralApplication dObj) {
		super.create(dObj);
	}
	
	public void update(CriticalCentralApplication dObj) {
		super.update(dObj);
	}
	...
	public CriticalCentralApplication getById(int id) {
		return (CriticalCentralApplication) super.getById(id);
	}
	
	@Override
	@SuppressWarnings("unchecked")
	public List<CriticalCentralApplication> getListByOwnerId(int ownerId) {
		return (List<CriticalCentralApplication>) super.getListByOwnerId(ownerId);
	}

	@Override
	protected Class<? extends BaseDomainObject> getDomainObjectClass() {
		return CriticalCentralApplication.class;
	}

	@Override
	protected String getNamedListQuery() {
		return "CriticalCentralApplication.list";
	}

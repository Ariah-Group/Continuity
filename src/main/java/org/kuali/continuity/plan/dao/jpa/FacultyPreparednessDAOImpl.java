...
public class FacultyPreparednessDAOImpl extends BaseDAOImpl implements FacultyPreparednessDAO {

	public FacultyPreparedness get(int planId) {
		ContinuityPlan plan =  
			this.getEntityManager().find(ContinuityPlan.class, planId);
		return plan.getFacultyPreparedness();
	}

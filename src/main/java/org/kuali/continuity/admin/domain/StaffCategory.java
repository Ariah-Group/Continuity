...
@NamedQueries({
	@NamedQuery(name="StaffCategory.list",
		query="SELECT dObj FROM StaffCategory dObj WHERE dObj.systemDomainId = :systemDomainId ORDER BY dObj.orderNo"),
	@NamedQuery(name="StaffCategory.size",
		query="SELECT COUNT(dObj) FROM StaffCategory dObj WHERE dObj.systemDomainId = :systemDomainId")
})
@SuppressWarnings("serial")
public class StaffCategory extends BaseAdminOrderedDomainObject implements OrderedType {
	...
	public StaffCategory(Integer id) {
		super(id);
	}

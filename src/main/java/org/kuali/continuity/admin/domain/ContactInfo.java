...
@NamedQueries({
	@NamedQuery(name="ContactInfo.list",
		query="SELECT dObj FROM ContactInfo dObj WHERE dObj.systemDomainId = :systemDomainId ORDER BY dObj.orderNo"),
	@NamedQuery(name="ContactInfo.size",
		query="SELECT COUNT(dObj) FROM ContactInfo dObj WHERE dObj.systemDomainId = :systemDomainId")
})
@SuppressWarnings("serial")
public class ContactInfo extends BaseAdminOrderedDomainObject implements OrderedType {

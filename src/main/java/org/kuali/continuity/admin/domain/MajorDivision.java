...
@NamedQueries({
	@NamedQuery(name="MajorDivision.list",
		query="SELECT dObj FROM MajorDivision dObj WHERE dObj.systemDomainId = :systemDomainId"),
	@NamedQuery(name="MajorDivision.size",
		query="SELECT COUNT(dObj) FROM MajorDivision dObj WHERE dObj.systemDomainId = :systemDomainId")
})
@SuppressWarnings("serial")
public class MajorDivision extends BaseAdminDomainObject {
	...
	public MajorDivision(Integer id) {
		super(id);
	}

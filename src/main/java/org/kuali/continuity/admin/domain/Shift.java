...
@Table(name="Shift")
@NamedQueries({
	@NamedQuery(name="Shift.list",
		query="SELECT dObj FROM Shift dObj WHERE dObj.systemDomainId = :systemDomainId ORDER BY dObj.orderNo"),
	@NamedQuery(name="Shift.size",
		query="SELECT COUNT(dObj) FROM Shift dObj WHERE dObj.systemDomainId = :systemDomainId")
})
@SuppressWarnings("serial")
public class Shift extends BaseAdminOrderedDomainObject implements OrderedType {

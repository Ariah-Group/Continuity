...
@NamedQueries({
	@NamedQuery(name="AnnualReview.list",
		query="SELECT dObj FROM AnnualReview dObj WHERE dObj.systemDomainId = :systemDomainId ORDER BY dObj.orderNo"),
	@NamedQuery(name="AnnualReview.size",
		query="SELECT COUNT(dObj) FROM AnnualReview dObj WHERE dObj.systemDomainId = :systemDomainId")
})
@SuppressWarnings("serial")
public class AnnualReview extends BaseAdminOrderedDomainObject implements OrderedType {
	...
	public AnnualReview(Integer id) {
		super(id);
	}

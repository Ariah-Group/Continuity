...
@NamedQueries({
	@NamedQuery(name="Reference.list",
		query="SELECT dObj FROM Reference dObj WHERE dObj.systemDomainId = :systemDomainId ORDER BY dObj.orderNo"),
	@NamedQuery(name="Reference.size",
		query="SELECT COUNT(dObj) FROM Reference dObj WHERE dObj.systemDomainId = :systemDomainId")
})
@SuppressWarnings("serial")
public class Reference extends BaseAdminOrderedDomainObject implements OrderedType {

...
@Entity
@Table(name="SystemDomainCriticalLevelAppl")
@TypeDef(
		name="stringValueEnum", 
		typeClass=StringValuedEnumType.class)
@NamedQueries({
	@NamedQuery(name="SystemDomainCentralApplicationCriticalityLevel.list",
		query="SELECT dObj FROM SystemDomainCentralApplicationCriticalityLevel dObj WHERE dObj.systemDomainId = :systemDomainId"),
	@NamedQuery(name="SystemDomainCentralApplicationCriticalityLevel.size",
		query="SELECT COUNT(dObj) FROM SystemDomainCentralApplicationCriticalityLevel dObj WHERE dObj.systemDomainId = :systemDomainId")
})
@SuppressWarnings("serial")
public class SystemDomainCentralApplicationCriticalityLevel extends
		SystemDomainCriticalityLevel implements
		CentralApplicationCriticalityLevel {

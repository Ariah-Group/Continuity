...
@Table(name="Utility")
@NamedQueries({
	@NamedQuery(name="Utility.list",
		query="SELECT dObj FROM Utility dObj WHERE dObj.systemDomainId = :systemDomainId ORDER BY dObj.orderNo"),
	@NamedQuery(name="Utility.size",
		query="SELECT COUNT(dObj) FROM Utility dObj WHERE dObj.systemDomainId = :systemDomainId")
})
@SuppressWarnings("serial")
public class Utility extends BaseAdminOrderedDomainObject implements OrderedType {

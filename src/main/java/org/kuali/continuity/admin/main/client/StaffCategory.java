...
public class StaffCategory extends SimpleGridViewer  {
	
	public void onModuleLoad()  {
		super.onModuleLoad("Categories");
		String name="Staff Category";
		setButtonNames(name);
		String plural="Staff Categories";
		setHeadingName(plural+" Setup");
	    flexForm.addFormItem(name, textBox);
	    flexForm.addFormItem("Order", orderBox);
		gridPanel.setTitle("Categories");

...
public class ContinuityPlanAdminValidationServiceTest extends BasePlanTest {
	
	private ContinuityPlanAdminValidationService service;
	...
	static {
		...
		adminClasses.put(SystemDomain.class, 29);
	}

	public void setDaoFactory(ContinuityPlanAdminValidationService service) {
		this.service = service;
	}

	public void testInjection() throws Exception {
		String message = "DAO Factory is: " + this.service.toString();
	...
	public void testGetPlans() {
		...
		for (Class<? extends BaseAdminDomainObject> adminClass : adminSet) {
			...
			List<Object[]> objList = this.service.getPlans(adminClass, testId);

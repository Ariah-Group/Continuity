...
public class WorkFromHomeStaffMemberDAOTest extends DomainObjectTest {

	private WorkFromHomeStaffMemberDAO dao;
	
	public void setWorkFromHomeStaffMemberDAO(WorkFromHomeStaffMemberDAO dao) {
		this.dao = dao;
	}
	...
	private void doTestCreate() throws Exception {
		// get list
		List<WorkFromHomeStaffMember> dObjs = this.dao.getListByOwnerId(PlanTestData.known_plan);

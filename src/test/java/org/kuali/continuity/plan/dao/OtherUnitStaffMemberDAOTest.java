...
public class OtherUnitStaffMemberDAOTest extends DomainObjectTest {

	private OtherUnitStaffMemberDAO dao;
	
	public void setOtherUnitStaffMemberDAO(OtherUnitStaffMemberDAO dao) {
		this.dao = dao;
	}
	...
	private void doTestCreate() throws Exception {
		// get list
		List<OtherUnitStaffMember> dObjs = this.dao.getListByOwnerId(PlanTestData.known_plan);
